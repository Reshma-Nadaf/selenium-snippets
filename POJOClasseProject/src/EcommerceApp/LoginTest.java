...
public class LoginTest {
	...
	public static void main(String[] args) {
		...
		RequestSpecification deleteProductreq = given().spec(deleteProduct).pathParam("product_id",prodcutID);
		String deleteProdres = deleteProductreq.when().delete("api/ecom/product/delete-product/{product_id}").then()
