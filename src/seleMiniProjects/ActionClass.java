...
public class ActionClass {
	...
	public static void main(String[] args) {
		...
		WebElement Button_clickMe = driver.findElement(By.xpath("(//button[contains(text(),'Click Me')])[3]"));
		JavascriptExecutor js =(JavascriptExecutor)driver;
		js.executeScript("arguments[0].setAttribute('style', arrguments[1]);", Button_clickMe, "background:yellow; boarder: 2px sloid red;");
